...
from ..modules.locacenc import VoxCPMLocAcEnc
...
class VoxCPMModel(nn.Module):
    def __init__(
        ...
        self.feat_encoder = VoxCPMLocAcEnc(encoder_config, input_dim=config.feat_dim)
    ...
    def _generate_with_prompt_cache(
        ...
        streaming: bool = False,
    ) -> Generator[tuple[torch.Tensor, torch.Tensor, torch.Tensor | list[torch.Tensor]], None, None]:
        """
    ...
    def clear_cache(self):
        self.base_lm.kv_cache.clear()
        self.residual_lm.kv_cache.clear()
